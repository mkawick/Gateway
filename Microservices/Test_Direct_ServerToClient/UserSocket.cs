...
namespace Test_Direct_ServerToClient
{
    public class UserSocket
    {
        ...
        private ServerController gateway;// just a reference
        ...
        public UserSocket(int _connectionId, ServerController _game, PlayerConnectionState _pcs, int _accountId)
        {
        ...
        public ServerController Gateway
        {
            get
            {
                return gateway;
