...
namespace HeadlessClient01
{
    class MyPlayer
    {
        ...
        TalkingToGatewayController testClient;
    ...
    class ScriptItem
    {
        int timeStampInMs;
        int waitTimeInMs;
        Vector3 startRotation, destRotation;
        enum Type
        {
            MoveTo, Wait, Rotate
        }
        Type scriptType;
        Vector3 startPostion, destination;
        MyPlayer player;
        ...
        public void Randomize(MyPlayer _player, Random rand)
        {
            ...
            var enumMemberCount = Enum.GetNames(typeof(Type)).Length;
